...
pdf("/home/flip/Documents/project/HapStick/total.pdf")


data <- dataFrame
data[data$shifting < 0,]$shifting <- data[data$shifting < 0,]$shifting * -1
...
p1 <- p1 + labs(x= "Shift (absolute) in cm", y= "Probability of correct decisions in %") + theme_minimal()
...
png("/home/flip/Documents/project/HapStick/total.png")
